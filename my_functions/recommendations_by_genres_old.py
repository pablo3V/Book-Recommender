...
def contains_all_genres_v0(row, genres):
...
def contains_any_genre_v0(row, genres):
...
def books_satisfying_genres_v0(data, books_genres, genres, exclude=[], combine=False): 
